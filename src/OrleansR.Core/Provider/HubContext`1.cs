...
/// </summary>
internal sealed class HubContext<THubClient>(HubContext hubContext) : IHubContext<Hub<THubClient>, THubClient>
    where THubClient : class
{
    private readonly HubContext hubContext = hubContext ?? throw new ArgumentNullException(nameof(hubContext));
